...
function PredictionsHistory({ matches }) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-900 rounded-3xl p-5 md:p-6 border border-slate-800 shadow-2xl">
        ...
        <p className="text-slate-400 text-sm">
          Los pronósticos de cada partido se muestran automáticamente cuando vence el plazo de edición: 15 minutos antes del inicio.
        </p>
      </div>
